...
pub fn get_tweaks() -> PrivacyTweaks {
    let basic_defs = vec![
        (
            ...
            "Stop apps from using your advertising ID",
            "green",
        ...
        (
            "privacy.typing_telemetry",
            "Disable Typing Telemetry",
            "Stop sending typing data to Microsoft",
            "green",
        ...
        (
            ...
            "Stop Start menu from searching the web",
            "green",
        ...
        (
            ...
            "Stop suggested content notifications",
            "green",
        ...
        (
            "privacy.lockscreen_ads",
            "Disable Lock Screen Ads",
            "Remove rotating ads from lock screen",
            "green",
            "HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\ContentDeliveryManager",
    ...
    let standard_defs = vec![
        (
            ...
            "Minimize Telemetry",
            "Reduce Windows telemetry to minimum level",
            "yellow",
        ...
        (
            ...
            "Stop the Connected User Experiences and Telemetry service",
            "yellow",
            "Service: DiagTrack",
            "StartType",
            "Disabled",
    ...
    let advanced_defs = vec![
        (
            "privacy.camera_deny",
            "Block Camera Access",
            "Deny all apps access to camera",
            "red",
        ...
        (
            "privacy.microphone_deny",
            "Block Microphone Access",
            "Deny all apps access to microphone",
            "red",
            "HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows\\AppPrivacy",
